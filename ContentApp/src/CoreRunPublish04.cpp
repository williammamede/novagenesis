/*
	...
	Name:		CoreRunPublish04
	Object:		CoreRunPublish04
	File:		CoreRunPublish04.cpp
...
CoreRunPublish04::CoreRunPublish04 (string _LN, Block *_PB, MessageBuilder *_PMB) : Action (_LN, _PB, _PMB)
{
}

CoreRunPublish04::~CoreRunPublish04 ()
{
}

// Run the actions behind a received command line
// ng -run --publish 0.4 [ < 1 string FileName > ]
int
CoreRunPublish04::Run (Message *_ReceivedMessage, CommandLine *_PCL, vector<Message *> &ScheduledMessages, Message *&InlineResponseMessage)
{
  int Status = OK;
  string Offset = "                    ";
  Core *PCore = 0;
			  ...
			  for (unsigned int i = 0; i < PCore->PeerClientAppTuples.size (); i++)
				{
				  ...
				  PT = PCore->PeerClientAppTuples[i];
...
void CoreRunPublish04::CreatePublishMessage (string _FileName, vector<Tuple *> &_PubNotify, vector<Tuple *> &_SubNotify)
{
  string Offset = "                    ";
  Core *PCore = 0;
  vector<string> Limiters;

...
class CoreRunInitialize01 : public Action {
 public:

  // Constructor
  CoreRunInitialize01 (string _LN, Block *_PB, MessageBuilder *_PMB);

  // Destructor
  virtual ~CoreRunInitialize01 ();
